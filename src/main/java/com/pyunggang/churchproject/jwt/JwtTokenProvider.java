...
public class JwtTokenProvider {
     ...
     */
    public TokenInfoParam generateToken(Authentication authentication) {
        // 권한 가져오기
        ...
        String accessToken = Jwts.builder()
                ...
                .setExpiration(accessTokenExpiresIn) // 만료 기한
